...
import { addCountry, updateCountry ,getCountryById} from 'module/admin/container/countryContainer/slice';
...
const AddEditModal = ({ formtype, data, handleClose }) => {
  ...
  const countryById = useSelector((state) => state.country.country.countryByIdData);
