...
import { Button,Grid, Box, Card, CardContent, Divider, Typography } from '@mui/material';
...
import { getProfileById,updateProfile } from 'module/vendor/container/profile/slice';
 
function Index() {
  const profileDetails = useSelector((state) => state.data.profile.profileByIdData);
 ...
 useEffect(() => {
  if (userData && userData.userId) {
    dispatch(getProfileById({ userId: userData.userId }));
  }
}, [dispatch, userData]);
...
//   const profileById = useSelector((state) => state.country.country.profileByIdData);
//   const initialValues = {
//     contactMobile1: '',
//     contactMobile2: '',
//     // GSTIN: '',
...
//                     <Field type="text" placeholder="Bank Name" name="BankName" as={TextField} />
//                     <ErrorMessage
//                       name="BankName"
//                       component="div"
//                       style={{
...
//                   <Grid item xs={12} sm={4}>
//                     <Typography>Accountant Name</Typography>
//                     <Field type="text" placeholder="Accountant Name" name="AccountantName" as={TextField} />
//                     <ErrorMessage
//                       name="AccountantName"
//                       component="div"
//                       style={{
...
//                   <Grid item xs={12} sm={4}>
//                     <Typography>Account </Typography>
//                     <Field type="text" placeholder="Account Type" name="AccountType" as={TextField} />
//                     <ErrorMessage
//                       name="AccountType"
//                       component="div"
//                       style={{
...
//                   <Grid item xs={12} sm={4}>
//                     <Typography>Account Number</Typography>
//                     <Field type="number" placeholder="Account Number" name="AccountNo" as={TextField} />
//                     <ErrorMessage
//                       name="AccountNo"
//                       component="div"
//                       style={{
...
//                   <Grid item xs={12} sm={4}>
//                     <Typography>Branch Name</Typography>
//                     <Field type="text" placeholder="Branch Name" name="BranchName" as={TextField} />
//                     <ErrorMessage
//                       name="BranchName"
//                       component="div"
//                       style={{
...
//                   <Grid item xs={12} sm={4}>
//                     <Typography>Branch Address</Typography>
//                     <Field type="text" placeholder="Branch Address" name="BranchAddress" as={TextField} />
//                     <ErrorMessage
//                       name="BranchAddress"
//                       component="div"
//                       style={{
...
//                   <Grid item xs={12} sm={4}>
//                     <Typography>IFSC Code</Typography>
//                     <Field type="text" placeholder="IFSC Code" name="IFSCCode" as={TextField} />
//                     <ErrorMessage
//                       name="IFSCCode"
//                       component="div"
//                       style={{
...
//                   <Grid item xs={12} sm={4}>
//                     <Typography>UPI Id</Typography>
//                     <Field type="text" placeholder="UPI Id" name="UPIId" as={TextField} />
//                     <ErrorMessage
//                       name="UPIId"
//                       component="div"
//                       style={{
...
//                   <Grid item xs={12} sm={4}>
//                     <Typography>Credit Period</Typography>
//                     <Field type="text" placeholder="Credit Period" name="CreditPeriod" as={TextField} />
//                     <ErrorMessage
//                       name="CreditPeriod"
//                       component="div"
//                       style={{
...
//                   <Grid item xs={12} sm={4}>
//                     <Typography>Credit Limit</Typography>
//                     <Field type="text" placeholder="Credit Limit" name="CreditLimit" as={TextField} />
//                     <ErrorMessage
//                       name="CreditLimit"
//                       component="div"
//                       style={{
