...
import { getProfile } from 'module/vendor/container/profile/slice';
...
function Index() {
    ...
    const profileData = useSelector(state => state.profile.profile.profileData.rows);
    useEffect(() => {
        dispatch(getProfile());
    }, [dispatch]);

    console.log('=======profileData.rows=======', profileData);
